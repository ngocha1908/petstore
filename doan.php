...
<body>
  <header>
    ...
    <div class="menu">
      ...
      <li><a href="THÚ CƯNG">THÚ CƯNG <i class="fa fa-caret-down"></i></a>
        <ul class="petmenu">
      ...
      <li><a href="PHỤ KIỆN">PHỤ KIỆN <i class="fa fa-caret-down"></i></a>
      ...
      <li><a href="DICHVU">DỊCH VỤ <i class="fa fa-caret-down"></i></a>
        <ul class="dichvumenu">
      ...
      <li><a href="THÔNG TIN">THÔNG TIN</a></li>
