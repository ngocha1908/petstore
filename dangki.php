...
<body>
  ...
  <main>
    <h1 style="color:aqua;">ĐĂNG KÝ</h1>
    <h2 style="color:white;">THÔNG TIN CÁ NHÂN</h2>
    <form action="dangki_submit.php" method="POST">
    <div class="dky">
      <label><i class="fas fa-user"  style="color:orange; margin-right: 5px;margin-bottom: 10px;"></i>Tên đăng nhập/Email <span style="color:crimson">*</span></label>
      <input type="text" name="username">
  
    </div>
    <div class="dky">
      <label><i class="far fa-phone-plus" style="color:orange; margin-right: 5px;margin-bottom: 10px;"></i>Số điện thoại <span style="color:crimson">*</span></label>
      <input type="text" name="phone">
    
    </div>
    <div class="dky">
      <label><i class="fas fa-lock" style="color:orange; margin-right: 5px;margin-bottom: 10px;"></i>Mật khẩu <span style="color:crimson">*</span></label>
      <input type="password" name="password">
     
    </div>
    <div class="dky">
      <label><i class="fas fa-lock" style="color:orange; margin-right: 5px;margin-bottom: 10px;"></i>Nhập lại mật khẩu <span style="color:crimson">*</span></label>
